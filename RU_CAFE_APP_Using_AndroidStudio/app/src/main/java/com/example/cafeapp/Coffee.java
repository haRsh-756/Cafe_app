 ...
 */
public class Coffee extends MenuItem implements Parcelable {
    /**
     * cup size
     */
    ...
    protected Coffee(@NonNull Parcel in) {
        CUP_SIZE = in.readInt();
        addIns = in.createStringArrayList();
        qty = in.readInt();
    }
    ...
    public void writeToParcel(@NonNull Parcel parcel, int i) {
        parcel.writeInt(CUP_SIZE);
        parcel.writeStringList(addIns);
        parcel.writeInt(qty);
    }
